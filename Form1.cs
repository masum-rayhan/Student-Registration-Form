...
namespace StudentManagementForm
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source = RAYHAN\SQLEXPRESS; Initial Catalog = Student_Registration_Form; User ID = sa; Password = 1234");
        SqlCommand cmd;
        SqlDataReader read;
        string id;
        bool Mode = true;
        ...
        //Loading the Data Grid View Data
